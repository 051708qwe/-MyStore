...
public class activity_info {
    ...
    public static activity_info objectFromData(String str) {

        return new Gson().fromJson(str, activity_info.class);
    }

    public static activity_info objectFromData(String str, String key) {

        try {
            JSONObject jsonObject = new JSONObject(str);

            return new Gson().fromJson(jsonObject.getString(str), activity_info.class);
    ...
    public static List<activity_info> arrayactivity_infoFromData(String str) {

        Type listType = new TypeToken<ArrayList<activity_info>>() {
        }.getType();

        return new Gson().fromJson(str, listType);
    }

    public static List<activity_info> arrayactivity_infoFromData(String str, String key) {
