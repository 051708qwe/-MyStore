...
public class ProfitInfo {
    ...
    public static ProfitInfo objectFromData(String str, String key) {

        try {
            JSONObject jsonObject = new JSONObject(str);

            return new Gson().fromJson(jsonObject.getString(str), ProfitInfo.class);
    ...
    public static List<ProfitInfo> arrayProfitInfoFromData(String str) {

        Type listType = new TypeToken<ArrayList<ProfitInfo>>() {
        }.getType();

        return new Gson().fromJson(str, listType);
    }

    public static List<ProfitInfo> arrayProfitInfoFromData(String str, String key) {
